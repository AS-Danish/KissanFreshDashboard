        ...
        <>
                <div className="dashboard-page dashboard-page-narrow">
                    <div className="flex items-center gap-4">
                        ...
                        <h2 className="text-2xl font-bold tracking-tight text-foreground">Create New Coupon</h2>
                    </div>

                    <Card className="relative overflow-visible">
                        <form onSubmit={handleSubmit} className="relative z-10">
                            <CardHeader className="border-b border-border/60 pb-5">
                                <CardTitle className="text-2xl">Coupon Details</CardTitle>
                                <CardDescription className="text-base text-muted-foreground/80">
                                    Configure discount rules and usage limits for the new coupon.
                                </CardDescription>
                            </CardHeader>
                            ...
                            <CardFooter className="sticky bottom-0 z-20 flex justify-between gap-3 border-t border-border/70 bg-card/95 p-4 backdrop-blur-xl sm:p-6">
                                ...
                                <Button type="submit" disabled={saving} className="shadow-lg shadow-primary/20 transition-all hover:-translate-y-0.5 min-w-32 active:translate-y-0">
                                    {saving ? (
