    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const productData = {
                ...
                description,
                category,
                unit: hasVariations ? "" : unit,
                unitValue: hasVariations ? "" : (unitValue || "1"),
                mrp: hasVariations ? 0 : (parseFloat(mrp) || parseFloat(price)),
                discountPercentage: hasVariations ? 0 : (parseFloat(discountPercentage) || 0),
                                    ...
                                    <>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <div className="grid gap-3 group/input">
                                                ...
                                                <Select required={!hasVariations} value={unit} onValueChange={setUnit}>
